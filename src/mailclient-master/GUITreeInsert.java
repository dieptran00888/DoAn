...
public class GUITreeInsert extends JFrame implements ActionListener {
    ...
    public void directorieSearch() {
        File driveC = new File(
                "/Users/tran.xuan.diep/NetBeansProjects/DoAn/src/");
    ...
    public void changeEmailContent() {
        File source = new File(
                "/Users/tran.xuan.diep/NetBeansProjects/DoAn/src/" + sourcePath.getLastPathComponent() + "/" + selectedNode);
        File ziel = new File(
                "/Users/tran.xuan.diep/NetBeansProjects/DoAn/src/" + goal + "/" + selectedNode);
